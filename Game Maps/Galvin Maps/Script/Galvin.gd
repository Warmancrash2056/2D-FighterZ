...
func _ready() -> void:
	...
	player_1_spawn.Controller = preload('res://Character Resouces/Global/Controller Resource/Player_1.tres')
	player_1_spawn.position = Vector2(192, -328)
	call_deferred("add_child", player_1_spawn)

	player_2_spawn.Controller = preload('res://Character Resouces/Global/Controller Resource/Player_2.tres')
